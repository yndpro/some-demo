...
var WaterMark = /** @class */ (function () {
    ...
    WaterMark.prototype.init = function () {
        var _this = this;
        this.getImgFromDataSource(this.dataSource, this.dataSourceType, function (img) {
            var base64 = _this.drawToCanvas(img);
            _this.success(base64);
        });
    };
    WaterMark.prototype.getBase64FromImgFile = function (file, callBack) {
    ...
    WaterMark.prototype.getImgFromDataSource = function (dataSource, dataSourceType, callback) {
        var img = new Image();
        if (dataSourceType == "image") {
            ...
            this.getBase64FromImgFile(dataSource, function (base64str) {
                img.src = base64str;
            });
        }
        img.onload = function () {
    ...
    WaterMark.prototype.drawToCanvas = function (img) {
